...
paths = {
    'weights_path': f"{ai_dir}/model_files/{model_name}_weights.hdf5",
    'vocab_path': f"{ai_dir}/model_files/{model_name}_vocab.json",
    'config_path': f"{ai_dir}/model_files/{model_name}_config.json",
}
